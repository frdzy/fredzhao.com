    ...
    65005: function (t, e, i) {
      ...
      (G.isLet = function () {
          ...
          switch ((this.isLet() && ((s = E._var), (r = 'let')), s)) {
            ...
            case E._import:
              return (
                ...
                s === E._import ? this.parseImport(n) : this.parseExport(n, i)
              );
            default:
        ...
        (G.parseSwitchStatement = function (t) {
          ...
          this.next(),
            ...
            this.labels.push(K),
            this.enterScope(0);
          for (var r = !1; this.type !== E.braceR; )
            if (i.type === E._case || i.type === E._default) {
              ...
              e || i.unexpected(), e.consequent.push(i.parseStatement(null));
          return (
            this.exitScope(),
      ...
      (G.parseTryStatement = function (t) {
        ...
        (G.parseLabeledStatement = function (t, e, i, r) {
          for (var s = this, n = 0, a = s.labels; n < a.length; n += 1) {
            a[n].name === e &&
              s.raise(i.start, "Label '" + e + "' is already declared");
          }
          for (
          ...
          return (
            this.labels.push({ name: e, kind: o, statementStart: this.start }),
            (t.body = this.parseStatement(r)),
          ...
          for (t.declarations = [], t.kind = i; ; ) {
            ...
            if (
              ...
              r.eat(E.eq)
                ...
                : r.unexpected(),
              t.declarations.push(r.finishNode(s, 'VariableDeclarator')),
              !r.eat(E.comma))
            )
              break;
          }
      ...
      (G.parseFunction = function (t, e, i, r) {
        ...
        (G.parseClassElement = function () {
          ...
          var e = this.startNode(),
            i = function (i, r) {
              ...
              return (
                !!t.eatContextual(i) &&
                (!(t.type === E.parenL || (r && t.canInsertSemicolon())) ||
                  (e.key && t.unexpected(),
                  (e.computed = !1),
                  (e.key = t.startNodeAt(s, n)),
                  (e.key.name = i),
          ...
          var r = this.eat(E.star),
            s = !1;
          r ||
            (this.options.ecmaVersion >= 8 && i('async', !0)
              ? ((s = !0),
                (r = this.options.ecmaVersion >= 9 && this.eat(E.star)))
              : i('get')
              ? (e.kind = 'get')
              : i('set') && (e.kind = 'set')),
        ...
        (G.parseExport = function (t, e) {
          ...
          if (this.eat(E._default)) {
            ...
            if (
              ...
              this.next(),
                i && this.next(),
                (t.declaration = this.parseFunction(r, 4 | Y, !1, i, !0));
        ...
        (G.parseExportSpecifiers = function (t) {
          ...
          for (this.expect(E.braceL); !this.eat(E.braceR); ) {
            if (r) r = !1;
            else if ((e.expect(E.comma), e.afterTrailingComma(E.braceR))) break;
            var s = e.startNode();
            (s.local = e.parseIdent(!0)),
              (s.exported = e.eatContextual('as') ? e.parseIdent(!0) : s.local),
              e.checkExport(t, s.exported.name, s.exported.start),
              i.push(e.finishNode(s, 'ExportSpecifier'));
          }
          return i;
        }),
        ...
        (G.parseImportSpecifiers = function () {
          ...
          for (this.expect(E.braceL); !this.eat(E.braceR); ) {
            if (i) i = !1;
            else if ((t.expect(E.comma), t.afterTrailingComma(E.braceR))) break;
            var n = t.startNode();
            (n.imported = t.parseIdent(!0)),
              t.eatContextual('as')
                ? (n.local = t.parseIdent())
                : (t.checkUnreserved(n.imported), (n.local = n.imported)),
              t.checkLVal(n.local, 2),
              e.push(t.finishNode(n, 'ImportSpecifier'));
          }
          return e;
        }),
      ...
      (tt.toAssignable = function (t, e, i) {
        ...
        (tt.parseBindingList = function (t, e, i) {
          for (var r = this, s = [], n = !0; !this.eat(t); )
            if ((n ? (n = !1) : r.expect(E.comma), e && r.type === E.comma))
              s.push(null);
            else {
              if (i && r.afterTrailingComma(t)) break;
              if (r.type === E.ellipsis) {
                var a = r.parseRestBinding();
                r.parseBindingListItem(a),
                  s.push(a),
                  r.type === E.comma &&
                    r.raise(
                      r.start,
      ...
      (et.checkPropClash = function (t, e, i) {
        ...
        (et.parseExpression = function (t, e) {
          ...
          if (this.type === E.comma) {
            ...
            for (n.expressions = [s]; this.eat(E.comma); )
        ...
        (et.parseExprOp = function (t, e, i, r, s) {
          ...
          if (null != n && (!s || this.type !== E._in) && n > r) {
            ...
            var p = this.start,
              h = this.startLoc,
              c = this.parseExprOp(this.parseMaybeUnary(null, !1), p, h, n, s),
          ...
          if (
            ...
            for (; this.type.postfix && !this.canInsertSemicolon(); ) {
              ...
              (p.operator = r.value),
                ...
                r.checkLVal(i),
                r.next(),
                (i = r.finishNode(p, 'UpdateExpression'));
            }
          }
        ...
        (et.parseSubscripts = function (t, e, i, r) {
          for (
            ...
            if ((a = s.eat(E.bracketL)) || s.eat(E.dot)) {
              var o = s.startNodeAt(e, i);
              (o.object = t),
                (o.property = a ? s.parseExpression() : s.parseIdent(!0)),
                (o.computed = !!a),
                a && s.expect(E.bracketR),
                (t = s.finishNode(o, 'MemberExpression'));
            } else if (!r && s.eat(E.parenL)) {
              var p = new z(),
                h = s.yieldPos,
                c = s.awaitPos;
              (s.yieldPos = 0), (s.awaitPos = 0);
              var l = s.parseExprList(
                E.parenR,
                s.options.ecmaVersion >= 8,
                !1,
                p
              );
              if (n && !s.canInsertSemicolon() && s.eat(E.arrow))
                return (
                  s.checkPatternErrors(p, !1),
                  s.checkYieldAwaitInDefaultParams(),
                  (s.yieldPos = h),
                  (s.awaitPos = c),
                  s.parseArrowExpression(s.startNodeAt(e, i), l, !0)
                );
              s.checkExpressionErrors(p, !0),
                (s.yieldPos = h || s.yieldPos),
                (s.awaitPos = c || s.awaitPos);
              var u = s.startNodeAt(e, i);
              (u.callee = t),
                (u.arguments = l),
                (t = s.finishNode(u, 'CallExpression'));
            } else {
              if (s.type !== E.backQuote) return t;
              var d = s.startNodeAt(e, i);
              (d.tag = t),
                (d.quasi = s.parseTemplate({ isTagged: !0 })),
                (t = s.finishNode(d, 'TaggedTemplateExpression'));
            }
        }),
          ...
          switch (this.type) {
            ...
            case E.name:
              ...
              if (
                ...
                return this.parseFunction(this.startNodeAt(r, s), 0, !1, !0);
              if (i && !this.canInsertSemicolon()) {
                if (this.eat(E.arrow))
                  return this.parseArrowExpression(
                    this.startNodeAt(r, s),
                    [a],
                    !1
                  );
                if (
                  ...
                  return (
                    ...
                    (!this.canInsertSemicolon() && this.eat(E.arrow)) ||
                      this.unexpected(),
                    this.parseArrowExpression(this.startNodeAt(r, s), [a], !0)
                  );
              }
              return a;
            case E.regexp:
        ...
        (et.parseParenAndDistinguishExpression = function (t) {
          ...
          if (this.options.ecmaVersion >= 6) {
            ...
            for (
              ...
              if (
                (c ? (c = !1) : i.expect(E.comma),
                n && i.afterTrailingComma(E.parenR, !0))
              ) {
                l = !0;
                break;
              }
              if (i.type === E.ellipsis) {
                (a = i.start),
                  h.push(i.parseParenItem(i.parseRestBinding())),
                  i.type === E.comma &&
                    i.raise(
                      i.start,
                      'Comma is not permitted after the rest element'
            ...
            if (
              ...
              return (
                ...
                (this.yieldPos = d),
                (this.awaitPos = f),
                this.parseParenArrowList(r, s, h)
              );
            (h.length && !l) || this.unexpected(this.lastTokStart),
              ...
              h.length > 1
                ? (((e = this.startNodeAt(o, p)).expressions = h),
                  this.finishNodeAt(e, 'SequenceExpression', m, y))
                : (e = h[0]);
      ...
      (et.parseNew = function () {
        ...
        var r = this.start,
          s = this.startLoc;
        return (
          (t.callee = this.parseSubscripts(this.parseExprAtom(), r, s, !0)),
          this.eat(E.parenL)
        ...
        (et.parseTemplate = function (t) {
          ...
          for (r.quasis = [s]; !s.tail; )
            e.type === E.eof && e.raise(e.pos, 'Unterminated template literal'),
              e.expect(E.dollarBraceL),
              r.expressions.push(e.parseExpression()),
              e.expect(E.braceR),
              r.quasis.push((s = e.parseTemplateElement({ isTagged: i })));
        ...
        (et.parseObj = function (t, e) {
          ...
          for (r.properties = [], this.next(); !this.eat(E.braceR); ) {
            if (s) s = !1;
            else if ((i.expect(E.comma), i.afterTrailingComma(E.braceR))) break;
        ...
        (et.parseProperty = function (t, e) {
          ...
          this.options.ecmaVersion >= 6 &&
            ((a.method = !1),
            (a.shorthand = !1),
            (t || e) && ((s = this.start), (n = this.startLoc)),
            t || (i = this.eat(E.star)));
          ...
          return (
            ...
            this.isAsyncProp(a)
              ...
              : (r = !1),
            this.parsePropertyValue(a, t, i, r, s, n, e, o),
            this.finishNode(a, 'Property')
          );
        }),
        (et.parsePropertyValue = function (t, e, i, r, s, n, a, o) {
          if (
            ((i || r) && this.type === E.colon && this.unexpected(),
            this.eat(E.colon))
          )
            (t.value = e
            ...
            'Identifier' === t.key.type
              ? (this.checkUnreserved(t.key),
                (t.kind = 'init'),
                e
                  ? (t.value = this.parseMaybeDefault(s, n, t.key))
                  : this.type === E.eq && a
        ...
        (et.parseFunctionBody = function (t, e) {
          ...
          if (i)
            ...
            (this.labels = []),
              ...
              this.checkParams(
                t,
                !r && !s && !e && this.isSimpleParamList(t.params)
              ),
        ...
        (et.parseExprList = function (t, e, i, r) {
          for (var s = this, n = [], a = !0; !this.eat(t); ) {
            if (a) a = !1;
            else if ((s.expect(E.comma), e && s.afterTrailingComma(t))) break;
            var o = void 0;
            i && s.type === E.comma
              ? (o = null)
              : s.type === E.ellipsis
      ...
      (rt.raise = function (t, e) {
        ...
        (rt.raiseRecoverable = rt.raise),
        (rt.curPosition = function () {
      ...
      (lt.initialContext = function () {
        ...
        (E.parenR.updateContext = E.braceR.updateContext =
          function () {
        ...
        (E._function.updateContext = E._class.updateContext =
          function (t) {
            t.beforeExpr &&
            t !== E.semi &&
            t !== E._else &&
            ((t !== E.colon && t !== E.braceL) ||
              this.curContext() !== ct.b_stat)
        ...
        (dt.regexp_eatUnicodePropertyValueExpression = function (t) {
          ...
          if (this.regexp_eatUnicodePropertyName(t) && t.eat(61)) {
            ...
            if (this.regexp_eatUnicodePropertyValue(t)) {
              ...
              return (
                this.regexp_validateUnicodePropertyNameAndValue(t, i, r), !0
              );
            }
          }
      ...
      (Et.next = function () {
            ...
            switch (e) {
              ...
              default:
                if (
                  !(
                    (e > 8 && e < 14) ||
                    (e >= 5760 && L.test(String.fromCharCode(e)))
                  )
                )
                  break t;
                ++t.pos;
        ...
        (Et.readToken_mult_modulo_exp = function (t) {
          ...
          return (
            ...
            61 === e ? this.finishOp(E.assign, i + 1) : this.finishOp(r, i)
          );
        }),
        ...
        (Et.readRegexp = function () {
          for (var t, e, i = this, r = this.pos; ; ) {
            i.pos >= i.input.length &&
              i.raise(r, 'Unterminated regular expression');
            var s = i.input.charAt(i.pos);
            if ((A.test(s) && i.raise(r, 'Unterminated regular expression'), t))
              t = !1;
            else {
              if ('[' === s) e = !0;
              else if (']' === s && e) e = !1;
        ...
        (Et.readInt = function (t, e) {
          for (
            var i = this, r = this.pos, s = 0, n = 0, a = null == e ? 1 / 0 : e;
            n < a;
            ++n
          ) {
        ...
        (Et.readString = function (t) {
          for (var e = this, i = '', r = ++this.pos; ; ) {
            ...
            if (s === t) break;
            92 === s
              ? ((i += e.input.slice(r, e.pos)),
                (i += e.readEscapedChar(!1)),
                (r = e.pos))
              : (I(s, e.options.ecmaVersion >= 10) &&
                  e.raise(e.start, 'Unterminated string constant'),
                ++e.pos);
          }
          return (
            (i += this.input.slice(r, this.pos++)),
            this.finishToken(E.string, i)
          );
        });
      var Ct = {};
      (Et.tryReadTemplateToken = function () {
        ...
        (Et.readTmplToken = function () {
          for (var t = this, e = '', i = this.pos; ; ) {
            ...
            if (96 === r || (36 === r && 123 === t.input.charCodeAt(t.pos + 1)))
              return t.pos !== t.start ||
                (t.type !== E.template && t.type !== E.invalidTemplate)
                ? ((e += t.input.slice(i, t.pos)), t.finishToken(E.template, e))
                : 36 === r
                ? ((t.pos += 2), t.finishToken(E.dollarBraceL))
                : (++t.pos, t.finishToken(E.backQuote));
            if (92 === r)
              (e += t.input.slice(i, t.pos)),
                (e += t.readEscapedChar(!0)),
                (i = t.pos);
            else if (I(r)) {
        ...
        (Et.readWord1 = function () {
          ...
          for (
            ...
            if (v(n, s)) t.pos += n <= 65535 ? 1 : 2;
              ...
              (i ? g : v)(o, s) ||
                t.invalidStringToken(a, 'Invalid Unicode escape'),
                (e += At(o)),
                (r = t.pos);
            }
            i = !1;
              ...
              return (function (e) {
                ...
                return (
                  ...
                  (i.prototype.jsx_readToken = function () {
                    for (var t = this, e = '', i = this.pos; ; ) {
                      t.pos >= t.input.length &&
                        t.raise(t.start, 'Unterminated JSX contents');
                      var r = t.input.charCodeAt(t.pos);
                      switch (r) {
                        case 60:
                        case 123:
                          return t.pos === t.start
                            ? 60 === r && t.exprAllowed
                              ? (++t.pos, t.finishToken(qt.jsxTagStart))
                              : t.getTokenFromCode(r)
                            : ((e += t.input.slice(i, t.pos)),
                              t.finishToken(qt.jsxText, e));
                        case 38:
                          (e += t.input.slice(i, t.pos)),
                            (e += t.jsx_readEntity()),
                            (i = t.pos);
                  ...
                  (i.prototype.jsx_readString = function (t) {
                    for (var e = this, i = '', r = ++this.pos; ; ) {
                      ...
                      38 === s
                        ...
                        : Vt(s)
                        ? ((i += e.input.slice(r, e.pos)),
                          (i += e.jsx_readNewLine(!1)),
                          (r = e.pos))
                        : ++e.pos;
                    }
                    return (
                      (i += this.input.slice(r, this.pos++)),
                      this.finishToken(Tt.string, i)
                    );
                  }),
                  (i.prototype.jsx_readEntity = function () {
                    ...
                    for (
                      var n = ++this.pos;
                      this.pos < this.input.length && r++ < 10;
                      ...
                      if (';' === (s = e.input[e.pos++])) {
                        '#' === i[0]
                          ? 'x' === i[1]
                            ...
                            : ((i = i.substr(1)),
                              Nt.test(i) &&
                                (t = String.fromCharCode(parseInt(i, 10))))
                          : (t = Lt[i]);
                        break;
                      }
                      i += s;
                  ...
                  (i.prototype.jsx_parseElementName = function () {
                    ...
                    for (
                      ...
                      (n.object = s),
                        (n.property = e.jsx_parseIdentifier()),
                        (s = e.finishNode(n, 'JSXMemberExpression'));
                    }
                    return s;
                  }),
                  ...
                  (i.prototype.jsx_parseOpeningElementAt = function (t, e) {
                    ...
                    for (
                      ...
                      r.attributes.push(i.jsx_parseAttribute());
                    return (
                      (r.selfClosing = this.eat(Tt.slash)),
        ...
        (ee.prototype = {
          addDeclaration: function (t, e) {
            for (var i = this, r = 0, s = Yt(t); r < s.length; r += 1) {
              var n = s[r],
                a = n.name,
                o = { name: a, node: n, kind: e, instances: [] };
              (i.declarations[a] = o),
                i.isBlockScope &&
                  (i.functionScope.blockScopedDeclarations[a] ||
                    (i.functionScope.blockScopedDeclarations[a] = []),
                  i.functionScope.blockScopedDeclarations[a].push(o));
            }
          },
        ...
        function e(e, i) {
          if ((t.call(this, e), (this.name = 'CompileError'), i)) {
            var r = i.program.magicString.original,
              s = ie(r, i.start);
            (this.message = e + ' (' + s.line + ':' + s.column + ')'),
              (this.stack = new t().stack.replace(
                new RegExp('.+new ' + this.name + '.+\\n', 'm'),
                ''
              )),
              (this.loc = s),
              (this.snippet = se(r, s, i.end - i.start));
          }
        }
        return (
          t && (e.__proto__ = t),
      ...
      var oe = {
        Identifier: he,
        AssignmentPattern: function (t, e, i, r, s, n, a) {
        ...
        ArrayPattern: function (t, e, i, r, s, n, a) {
          ...
          r.elements.forEach(function (r, p) {
            r &&
              ('RestElement' === r.type
                ? le(t, e, i, o, r.argument, s + '.slice(' + p + ')', n, a)
                : le(t, e, i, o, r, s + '[' + p + ']', n, a),
              (o = r.end));
          }),
            t.remove(o, r.end);
        },
        ...
        r.properties.forEach(function (r) {
          ...
          if ('Property' === r.type) {
            var u = r.computed || 'Identifier' !== r.key.type,
              d = u ? t.slice(r.key.start, r.key.end) : r.key.name;
            (c = u ? s + '[' + d + ']' : s + '.' + d),
              (l = r.value),
              h.push(u ? d : '"' + d + '"');
          } else {
      ...
      function le(t, e, i, r, s, n, a, o) {
        switch (s.type) {
          ...
          case 'MemberExpression':
            t.remove(r, s.start),
              (function (t, e, i, r, s, n, a) {
                a.push(function (e, i, a) {
                  t.prependRight(r.start, n ? i : i + 'var '),
                    t.appendLeft(r.end, ' = ' + s + a),
                    t.move(r.start, r.end, e);
                });
              })(t, 0, 0, s, n, !0, o);
            break;
            ...
            (p = h ? i(s.left) : e(n)),
              o.push(function (e, i, r) {
                a
                  ...
                  t.move(s.right.start, s.right.end, e);
              }),
              h
                ? t.remove(r, s.right.start)
                : (t.remove(r, s.left.start),
                  t.remove(s.left.end, s.right.start),
                  le(t, e, i, r, s.left, p, a, o));
            break;
          case 'ObjectPattern':
            ...
            s.properties.length > 1 &&
              ...
              o.push(function (e, i, o) {
                t.prependRight(s.start, (a ? '' : i + 'var ') + c + ' = '),
                  t.overwrite(s.start, (r = s.start + 1), n),
                  t.appendLeft(r, o),
                  t.overwrite(
                    s.start,
                    (r = s.start + 1),
          ...
          case 'ArrayPattern':
            if (
              (t.remove(r, (r = s.start)),
              s.elements.filter(Boolean).length > 1)
            ) {
              var l = e(n);
              o.push(function (e, i, o) {
                t.prependRight(s.start, (a ? '' : i + 'var ') + l + ' = '),
                  t.overwrite(s.start, (r = s.start + 1), n, {
                    contentOnly: !0,
                  }),
                  t.appendLeft(r, o),
                ...
                s.elements.forEach(function (s, n) {
                  s &&
                    ('RestElement' === s.type
                      ...
                      : le(t, e, i, r, s, l + '[' + n + ']', a, o),
                    (r = s.end));
                });
            } else {
              var u = ae(s.elements, Boolean),
                d = s.elements[u];
              'RestElement' === d.type
                ? le(t, e, i, r, d.argument, n + '.slice(' + u + ')', a, o)
                : le(t, e, i, r, d, n + '[' + u + ']', a, o),
                (r = d.end);
            }
            t.remove(r, s.end);
            break;
          default:
            throw new Error(
              'Unexpected node type in destructuring (' + s.type + ')'
            );
        }
      }
      var ue = (function (t) {
        ...
        return (
            ...
            if (void 0 === this.indentation) {
              for (
                var e = this.program.magicString.original,
                  i = this.synthetic || !this.body.length,
                  r = i ? this.start : this.body[0].start;
                r && '\n' !== e[r];
              ...
              for (
                ...
                'constructor' !== a.kind ||
                  ...
                  (t.indentation = t.indentation.replace(n, '')),
                  (a = a.parent);
          ...
          (e.prototype.transpile = function (e, i) {
            ...
            (s = this.body[0]),
              (r =
                s &&
                'ExpressionStatement' === s.type &&
                'Literal' === s.expression.type &&
                'use strict' === s.expression.value
                  ? this.body[0].end
          ...
          (e.prototype.transpileBlockScopedIdentifiers = function (t) {
            ...
            Object.keys(this.scope.blockScopedDeclarations).forEach(function (
              ...
              for (
                var r = 0, s = e.scope.blockScopedDeclarations[i];
                r < s.length;
                r += 1
              ) {
                var n = s[r],
      ...
      function fe(t, e, i, r, s) {
        for (var n = e.length, a = -1; n--; ) {
          ...
          o &&
            ...
            (de(o.argument) && t.overwrite(o.argument.start, o.argument.end, r),
            (a = n));
        }
        if (-1 === a) return !1;
        if (s) {
              ...
              if (1 === this.elements.length) {
                ...
                s &&
                  ...
                  (de(s.argument)
                    ...
                    : (e.overwrite(this.start, s.argument.start, '[].concat( '),
                      e.overwrite(s.end, this.end, ' )')));
              } else {
        ...
        return (
          ...
          (e.prototype.transpile = function (e, i) {
            ...
            i.trailingFunctionCommas &&
              this.params.length &&
              !r &&
              ye(e, this.params[this.params.length - 1].end);
          }),
      ...
      var xe = (function (t) {
          ...
          return (
            ...
            (e.prototype.transpileDestructuring = function (t) {
              var e = this,
                i = this.findScope(!0),
                r = this.findScope(!1),
                s = i.createDeclaration('assign');
              t.appendRight(this.left.end, '(' + s),
            ...
            (e.prototype.transpileExponentiation = function (t) {
              ...
              if ('Identifier' === s.type) e = i.resolveName(s.name);
                ...
                'Identifier' === s.property.type
                  ? (a = s.computed
                      ? i.resolveName(s.property.name)
                      : s.property.name)
                  : ((a = i.createDeclaration('property')), (p = !0)),
                  'Identifier' === s.object.type
                    ? (n = i.resolveName(s.object.name))
                  ...
                  s.start === h.start
                    ? o && p
                      ...
                      : o
                      ? (t.prependRight(h.start, n + ' = '),
                        t.appendLeft(s.object.end, ';\n' + c),
                        t.appendLeft(s.object.end, n))
                      : p &&
                        (t.prependRight(s.property.start, a + ' = '),
                        t.appendLeft(s.property.end, ';\n' + c),
                        t.move(s.property.start, s.property.end, this.start),
                        t.appendLeft(s.object.end, '[' + a + ']'),
                        t.remove(s.object.end, s.property.start),
                        t.remove(s.property.end, s.end))
                    : (o && p
                        ? (t.prependRight(s.start, '( ' + n + ' = '),
                          t.overwrite(
                            s.object.end,
                            s.property.start,
                            ', ' + a + ' = '
                        ...
                        : p &&
                          (t.prependRight(s.property.start, '( ' + a + ' = '),
                          t.appendLeft(s.property.end, ', '),
                          t.move(s.property.start, s.property.end, s.start),
                          t.overwrite(
                            s.object.end,
                            s.property.start,
                            '[' + a + ']'
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
                ...
                if (
                  (1 === this.arguments.length
                    ? 'SpreadElement' === n.type &&
                      (e.remove(n.start, n.argument.start), (s = !0))
                    : (s = fe(
                        e,
                        this.arguments,
                        n.start,
                  ...
                  e.appendLeft(this.callee.end, '.apply'),
                    a
                      ...
                      : 1 === this.arguments.length
                      ? e.prependRight(n.start, r + ', ')
                      : ('SpreadElement' === n.type
                          ? e.appendLeft(n.start, r + ', ')
                          : e.appendLeft(n.start, r + ', [ '),
                        e.appendLeft(
                          this.arguments[this.arguments.length - 1].end,
                          ' )'
              ...
              i.trailingFunctionCommas &&
                ...
                ye(e, this.arguments[this.arguments.length - 1].end),
                t.prototype.transpile.call(this, e, i);
            }),
            e
          );
        ...
        we = (function (t) {
          ...
          return (
            ...
            (e.prototype = Object.create(t && t.prototype)),
            (e.prototype.constructor = e),
            (e.prototype.transpile = function (e, i, r, s) {
              var n = this;
              if (i.classes) {
                  ...
                  (this.body.forEach(function (t, r) {
                    ...
                    if ('constructor' !== t.kind) {
                      ...
                      var o,
                        h = 'method' !== t.kind,
                        l = t.key.name;
                      (te[l] || t.value.body.scope.references[l]) &&
      ...
      var Ee = (function (t) {
          ...
          return (
            ...
            (e.prototype.initialise = function (e) {
              ...
              if (
                ...
                for (
                  var r = Object.keys(this.body.scope.declarations),
                    s = r.length;
                  s--;
                  ...
                  for (
                    ...
                    if (p && p.depth > i.depth) {
                      ...
                      for (var h = 0, c = i.thisRefs; h < c.length; h += 1) {
                        var l = c[h];
                        l.alias =
                          l.alias || l.findLexicalBoundary().getThisAlias();
                      }
                      break;
                    }
                  }
            ...
            (e.prototype.transpile = function (e, i) {
              ...
              if (this.shouldRewriteAsFunction) {
                var s = this.getIndentation(),
                  n = s + e.getIndentString(),
        ...
        Ne = (function (t) {
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
              var r = this,
                s = this.getIndentation() + e.getIndentString();
              if (this.shouldRewriteAsFunction) {
                var n =
        ...
        Te = (function (t) {
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
              var r = this,
                s = 'VariableDeclaration' === this.left.type;
              if (this.shouldRewriteAsFunction) {
                var n = s
            ...
            (e.prototype.destructurePattern = function (t, e, i) {
              var r = this.findScope(!0),
                s = this.getIndentation() + t.getIndentString(),
                n = r.createIdentifier('ref'),
          ...
          return (
            ...
            (e.prototype.initialise = function (e) {
              if (this.generator && e.generator)
                throw new ne('Generators are not supported', this);
              this.body.createScope(),
                this.id &&
          ...
          return (
            ...
            (e.prototype.initialise = function (e) {
              ...
              if (
                ...
                for (var s = 0, n = this.params; s < n.length; s += 1) {
                  var a = n[s];
      ...
      function Ve(t, e) {
        return 'MemberExpression' === t.type
          ? !t.computed && Ve(t.object, t)
          : 'Identifier' === t.type
          ? !e ||
            (!/(Function|Class)Expression/.test(e.type) &&
              ('VariableDeclarator' === e.type
                ? t === e.init
                : 'MemberExpression' === e.type || 'MethodDefinition' === e.type
                ? e.computed || t === e.object
                : 'ArrayPattern' !== e.type &&
                  ('Property' === e.type
                    ? 'ObjectPattern' !== e.parent.type &&
                      (e.computed || t === e.value)
                    : 'MethodDefinition' !== e.type &&
                      ('ExportSpecifier' !== e.type || t === e.local))))
          : void 0;
      }
      var De = (function (t) {
          function e() {
            ...
            (e.prototype.transpile = function (e, i) {
              ...
              if (n) {
                var o,
                  ...
                  c = !1;
                for (o = 0; o < n; o += 1)
                  if ('JSXSpreadAttribute' === r.attributes[o].type) {
                    c = !0;
                    break;
                  }
                for (a = this.attributes[0].end, o = 0; o < n; o += 1) {
                  ...
                  if (
                    (o > 0 &&
                      (l.start === a
                        ? e.prependRight(a, ', ')
                        : e.overwrite(a, l.start, ', ')),
                    c && 'JSXSpreadAttribute' !== l.type)
                  ) {
                    var u = r.attributes[o - 1],
                      d = r.attributes[o + 1];
                ...
                e.prependRight(this.name.end, h),
                  p && e.appendLeft(this.attributes[n - 1].end, p);
              } else
                e.appendLeft(this.name.end, s ? "', null" : ', null'),
                  (a = this.name.end);
              this.selfClosing
                ? e.overwrite(a, this.end, this.attributes.length ? ')' : ' )')
                : e.remove(a, this.end);
            }),
            e
          );
              ...
              if (
                ...
                'string' == typeof this.value &&
                  ...
                  t.overwrite(
                    this.start,
                    this.end,
                    this.raw.replace(Ye, function (t) {
                      return '\u2028' == t ? '\\u2028' : '\\u2029';
                    }),
                    { contentOnly: !0 }
                  );
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
              if (
                ...
                fe(e, this.arguments, r.start, this.argumentsArrayAlias, !0) &&
                  (e.prependRight(
                    this.start + 'new'.length,
                    ' (Function.prototype.bind.apply('
                  ),
                  e.overwrite(this.callee.end, r.start, ', [ null ].concat( '),
                  e.appendLeft(this.end, ' ))'));
              }
              this.arguments.length &&
                ye(e, this.arguments[this.arguments.length - 1].end);
        ...
        ii = (function (t) {
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
              ...
              t.prototype.transpile.call(this, e, i);
              for (
                var s = this.start + 1, n = 0, a = 0, o = null, p = null, h = 0;
                ...
                if (n) {
                  ...
                  for (var l = this.properties.length; l--; ) {
                    ...
                    if ('Property' === u.type && !a) {
                      var d = r.properties[l - 1],
                        f = r.properties[l + 1];
                      (d && 'Property' === d.type) ||
                        e.prependRight(u.start, '{'),
                        (f && 'Property' === f.type) ||
                          e.appendLeft(u.end, '}');
                    }
                    'SpreadElement' === u.type &&
                      (e.remove(u.start, u.argument.start),
                      e.remove(u.argument.end, u.end));
                  }
                ...
                m ||
                  (null === o || p < o
                    ? ((y = this.findScope(!0).createDeclaration('obj')),
                      e.prependRight(this.start, '( ' + y + ' = '))
                    : (y = null));
                for (
                  var b, _ = this.properties.length, k = !1, S = !0, w = 0;
                  w < _;
                  w += 1
                ) {
                  var E = r.properties[w],
                    A = w > 0 ? r.properties[w - 1].end : v;
                  if ('Property' === E.type && (E.computed || (b && !n))) {
                    if ((0 === w && (A = r.start + 1), (b = E), y)) {
                      ...
                      A < E.start
                        ? e.overwrite(A, E.start, C)
                        : e.prependRight(E.start, C);
                    } else {
                      var I =
                        (y = r.findScope(!0).createDeclaration('obj')) +
                        (E.computed ? '' : '.');
                    ...
                    'Literal' !== E.key.type || E.computed
                      ? E.shorthand ||
                        (E.method && !E.computed && i.conciseMethodProperty)
                        ? e.overwrite(
                            E.key.start,
                            E.key.end,
                            e.slice(E.key.start, E.key.end).replace(/:/, ' =')
                          )
                        : (E.value.start > L && e.remove(L, E.value.start),
                          e.prependLeft(L, ' = '))
                      : e.overwrite(
                          E.start,
                          E.key.end + 1,
                      ...
                      !E.method ||
                        (!E.computed && i.conciseMethodProperty) ||
                        (E.value.generator && e.remove(E.start, E.key.start),
                        e.prependRight(
                          E.value.start,
                    ...
                    'SpreadElement' === E.type
                      ? y &&
                        w > 0 &&
                        (b || (b = r.properties[w - 1]),
                        e.appendLeft(b.end, ', ' + y + ' )'),
                        (b = null),
                        (y = null))
                      : (!S &&
                          n &&
                  ...
                  if (S && ('SpreadElement' === E.type || E.computed)) {
                    var P = k
                      ? r.properties[r.properties.length - 1].end
                      : r.end - 1;
                    ',' == e.original[P] && ++P;
                    var N = e.slice(P, x);
                  ...
                  var T = E.end;
                  if (w < _ - 1 && !k) for (; ',' !== e.original[T]; ) T += 1;
                  else w == _ - 1 && (T = r.end);
            ...
            (e.prototype.initialise = function (t) {
              if (t.classes) {
                if (
                  ...
                  throw new ne('use of super outside class method', this);
                ...
                if (
                  ...
                  throw new ne('super used in base class', this);
                if (
                  ((this.isCalled =
            ...
            (e.prototype.transpile = function (t, e) {
              if (e.classes) {
                ...
                if (r && 'CallExpression' === r.type) {
                  ...
                  r.arguments.length
                    ? t.appendLeft(r.arguments[0].start, s + ', ')
                    : t.appendLeft(r.end - 1, '' + s);
                }
              }
            }),
            e
          ...
          return (
            ...
            (e.prototype.transpile = function (e, i) {
              if (i.templateString && i.dangerousTaggedTemplateString) {
                ...
                a ||
                  ((a = s.createIdentifier('templateObject')),
                  e.prependRight(
              ...
              if (
                ...
                r.forEach(function (t, i) {
                  ...
                  if ('TemplateElement' === t.type)
                    e.overwrite(o, t.end, r + JSON.stringify(t.value.cooked));
                  else {
                    var s = 'Identifier' !== t.type;
                    s && (r += '('),
                      e.remove(o, t.start),
                      r && e.prependRight(t.start, r),
                      s && e.appendLeft(t.end, ')');
                  }
                  o = t.end;
                }),
                  a && e.appendLeft(o, ')'),
        ...
        hi = (function (t) {
          ...
          return (
            ...
            (e.prototype.initialise = function (t) {
              var e = this.findLexicalBoundary();
              if (t.letConst)
                for (var i = this.findNearest(_e); i && i.depth > e.depth; )
                  i.thisRefs.push(this), (i = i.parent.findNearest(_e));
              if (t.arrow) {
            ...
            (e.prototype.transpile = function (t, e) {
              ...
              if (
                (e.letConst &&
                  'var' !== s &&
                  ((s = 'var'),
                  t.overwrite(this.start, this.start + this.kind.length, s, {
                    contentOnly: !0,
                    storeName: !0,
                  })),
                e.destructuring &&
                ...
                this.declarations.forEach(function (s, o) {
                  if ((s.transpile(t, e), 'Identifier' === s.id.type))
                    o > 0 &&
                      'Identifier' !== i.declarations[o - 1].id.type &&
                      t.overwrite(a, s.id.start, 'var ');
                  else {
                    var p = _e.test(i.parent.type);
                    0 === o
                      ? t.remove(a, s.id.start)
                      : t.overwrite(a, s.id.start, ';\n' + r);
                    var h = 'Identifier' === s.init.type && !s.init.rewritten,
                      c = h
                        ? s.init.alias || s.init.name
                        : s.findScope(!0).createIdentifier('ref');
                    a = s.start;
                    var l = [];
                    h
                      ? t.remove(s.id.end, s.end)
                      : l.push(function (e, i, r) {
                          t.prependRight(s.id.end, 'var ' + c),
                            t.appendLeft(s.init.end, '' + r),
                            t.move(s.id.end, s.end, e);
                        });
                    var u = s.findScope(!1);
                    pe(
                      t,
      ...
      function yi(t, e) {
        if (t)
          if ('length' in t) for (var i = t.length; i--; ) yi(t[i], e);
          else if (!t.__wrapped) {
            (t.__wrapped = !0),
              fi[t.type] ||
                (fi[t.type] = Object.keys(t).filter(function (e) {
            ...
            (t.parent = e),
              (t.program = e.program || e),
              (t.depth = e.depth + 1),
              (t.keys = fi[t.type]),
              (t.indentation = void 0);
            for (var n = 0, a = fi[t.type]; n < a.length; n += 1) {
              var o = a[n];
              yi(t[o], t);
            }
            t.program.magicString.addSourcemapLocation(t.start),
              t.program.magicString.addSourcemapLocation(t.end);
      ...
      function gi(t, e, i, r) {
        ...
        (this.type = 'Root'),
          ...
          (this.options = r),
          (this.source = t),
          (this.magicString = new n.ZP(t)),
          (this.ast = e),
          (this.depth = 0),
          yi((this.body = e), this),
          (this.body.__proto__ = ue.prototype),
          (this.templateLiteralQuasis = Object.create(null));
        for (var a = 0; a < this.body.body.length; ++a)
          if (!s.body.body[a].directive) {
        ...
        for (var o = 0, p = s.indentExclusionElements; o < p.length; o += 1)
          for (var h = p[o], c = h.start; c < h.end; c += 1)
            s.indentExclusions[c] = !0;
      ...
      var vi = {
        ...
        bi = X.extend(Qt, Jt()),
        _i = ['dangerousTaggedTemplateString', 'dangerousForOf'];
      function ki(t, e) {
        var i;
        void 0 === e && (e = {});
        var r = null;
            ...
            if ('modules' === t)
              return (
                'moduleImport' in e.transforms ||
                  (s.moduleImport = e.transforms.modules),
                void (
                  'moduleExport' in e.transforms ||
                  (s.moduleExport = e.transforms.modules)
                )
              );
...
//# sourceMappingURL=f0e45107-cb684130966d68c13c9c.js.map
