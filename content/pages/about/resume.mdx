...
- Recruiting Products - Discovery (Jul 2019 - Sep 2020):
  ...
  - Produce engineering: surfaced semantic search over candidate resumes to match with positions relevant to recruiting partners
  - Added data integration from industry news and layoff data, enabled timely outreach to newly available talent in competitive markets
