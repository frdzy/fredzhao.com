...
_Proudest projects highlighted with ❤️ emoji below._
...
- **Recruiting Products**: July 2019 - Current
  - Current Events
    ...
    - _Result_: xx incremental net hires of relevant candidates
- **Productivity Tools**: August 2017 - July 2019
  - ❤️ Internal Notification Management
    ...
    - _Result_: positive employee feedback, xx% reduction of notification noise, xx% action rate on suggestions
  - Tasks
...
- **Photos Infrastructure / Sharing Infrastructure**: July 2012 - July 2017
  - ❤️ Post Data Model Refactor
    ...
    - _Result_: enabled full attachment editing (text, photo, video, link, multimedia) across all platforms (web, native apps, m-site)
    - _Result_: simplified complexity matrix for developing new content features
  ...
  - Team-wide engineering practices
    ...
    - _Result_: many teammates and most practices have outlived my team tenure
