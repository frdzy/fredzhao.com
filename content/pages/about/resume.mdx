...
<p align="center">
  <b>Fred Y. Zhao</b><br/>
  <small><a href="/resume-pdf">View PDF version</a></small>
</p>
...
* **General: ❤️ Built and evolved critical internal tools, using Airtable itself**: task tracking system that replaced multiple legacy ones; escalation to Slack automations; internal RFC review tracker; engineering onboarding scheduler
  * Became an internal expert in & gave dogfooding feedback to every part of the product
...
* **Photos/Sharing Infrastructure (Jul 2012 - Jul 2017):**
  ...
  * Coordinated efforts across engineering teams in multiple organizations; the Ads Team still liked working with me in spite of my causing a SEV1 in revenue
